...
class FlappyBird:
	...
	self.screen = pygame.display.set_mode((width, height))			#Resolution of Screen
        ...
        self.background = pygame.image.load("data/background.png").convert()	#Background Image
        self.birdSprites = [pygame.image.load("data/1.png").convert_alpha(),	#Images of bird (Stable, Flying, Dead)
                            pygame.image.load("data/2.png").convert_alpha(),
                            pygame.image.load("data/dead.png")]
        self.wallUp = pygame.image.load("data/bottom.png").convert_alpha()	#Image of upper wall
        self.wallDown = pygame.image.load("data/top.png").convert_alpha()	#Image of lower wall
